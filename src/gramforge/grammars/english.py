...
def simple_english_grammar(cap=3, questions=True):
    ...
    nouns_v = [('artist', 'artists'), ('engineer', 'engineers')]
    ...
    R('decl_simple(there, is, det_sg_a, n_sg_c)', '{0} {1} {2} {3}')
    R('decl_simple(there, is, det_sg_an, n_sg_v)', '{0} {1} {2} {3}')
    R('decl_simple(there, are, det_pl_indef, n_pl)', '{0} {1} {2} {3}')
