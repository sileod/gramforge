...
- algorithms compared: sequential, sequential_exp
- runs per case: 200
- max_steps: 5000
- bushiness: 0.8
- k: 1
...
| arith   | 6->8       | sequential_exp | none            |
| arith   | 8->8       | sequential     | none            |
| arith   | 8->8       | sequential_exp | none            |
| dyck    | 6->8       | sequential     | none            |
| dyck    | 6->8       | sequential_exp | none            |
| dyck    | 8->8       | sequential     | none:138        |
| dyck    | 8->8       | sequential_exp | none:138        |
| english | 6->8       | sequential     | none:128        |
| english | 6->8       | sequential_exp | none:128        |
| english | 8->8       | sequential     | none:181        |
| english | 8->8       | sequential_exp | none:181        |
| fol     | 6->8       | sequential     | none:114        |
| fol     | 6->8       | sequential_exp | none:114        |
| fol     | 8->8       | sequential     | none:142        |
| fol     | 8->8       | sequential_exp | none:142        |
| tinypy  | 6->8       | sequential     | none:98         |
| tinypy  | 6->8       | sequential_exp | none:98         |
| tinypy  | 8->8       | sequential     | none:185        |
| tinypy  | 8->8       | sequential_exp | none:185        |
